            ...
            <c:forEach items="${list }" var="item" varStatus="stat">
                ...
                <li class="table-row" id="content${stat.index }" style="display:none;background-color:#F5FFFA">
                    <div class="col col-12">
                        <!-- 자유게시판 상세보기 -->
                        <table align="center" id="tb" cellpadding="10" cellspacing="0" border="1" width="700">
                            ...
                            <c:if test="${loginInfo.memberId eq item.memberId }">
                                <tr>
                                    <c:url var="fupdate" value="fupdateView.do">
                                        ...
                                        <!-- 쿼리스트링을 보내주어야 컨트롤러의 메소드의 매개변수(파라미터)가 받아서 처리가능 -->
                                    </c:url>
                        ...
                        <!-- 댓글 목록  -->
                        <table id="ctb" align="center" width="700" border="1" cellspacing="0">
                            <thead>
                                <tr>
    ...
    <div id="searchArea" align="center">
        ...
        <form action="fsearch.do" name="searchForm" method="get">
            <select id="searchCondition" name="searchCondition">
                ...
                <option value="title" <c:if test="${search.searchCondition=='title'}">selected</c:if>>제목+내용</option>
            </select> <input type="search" name="searchValue" value="${search.searchValue }">
            <button>검색</button>
        </form>
    </div>
