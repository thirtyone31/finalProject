...
<body>
	...
	<a href="loginMain.do" onclick="window.open('loginMain.do','login','resizable=no width=350 height=600');return false">로그인창</a>
	<%-- <jsp:forward page="/WEB-INF/views/member/loginMain.jsp"></jsp:forward> --%>
