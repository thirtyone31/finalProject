				...
				<div class="card-body">
					...
					<form name="frm1" id="frm1" action="newRegister.me" method="POST">
							...
							<div class="col-6">
								<div class="input-group" id="test">
									<input class="input--style-2" type="text" placeholder="아이디 입력"
										name="memberId" id="memberId" style="float: left;"> <input
										type="button" onclick="checkId();" value="중복 확인"
						...
						<div class="row row-space">
							<div class="col-6">
								<div class="input-group" id="test">
									<input class="input--style-2" type="password" class="pw"
										placeholder="비밀번호 확인" name="memberPwdRe" id="pwd2">
								</div>
							</div>
						</div>
						<strong>이름</strong>
						...
						<input type="hidden" name="checkedNick" id="checkedNick"
							value="false" /> <strong>닉네임</strong>
						<div class="row row-space">
							<div class="col-6">
								<div class="input-group" id="test">
									<input class="input--style-2 j" type="text" placeholder="닉네임"
										name="nickName" id="nickName"> <input type="button"
										onclick="checkNickName();" value="중복 확인"
										style="width: 110px; height: 30px; margin: 10px; float: left;">
								</div>
							</div>
						</div>
						...
						<div class="row row-space">
							<div class="col-6">
								<div class="input-group">
									<input class="input--style-2 datepicker" type="text"
										placeholder="생년월일" name="birthDay" id="birthDay"
										readonly="readonly"> <i
						...
						<div class="p-t-30">
							<button class="btn btn--radius btn--green" type="submit"
								onclick="return goRegist();">가입하기</button>
						</div>
					</form>
				</div>
			</div>
