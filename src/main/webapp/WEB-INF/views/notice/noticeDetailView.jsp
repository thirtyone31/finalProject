...
<body>
	...
	<section class="page-section bg-light" id="portfolio">
		...
		<h1 align="center">${notice.boardNo }번상세 보기</h1>
		...
		<div class="select" width="200px">
			<select class="custom-select mr-sm-2" id="inlineFormCustomSelect"
				name="nCategory" style="width: 110px; height: 35px;"
		...
		<table align="center" width="450" border="1" cellspacing="0"
			...
			<c:if
				test="${loginInfo.memberId eq notice.memberId or loginInfo.memberId == 'admin'}">
				<tr>
					<td colspan="2" align="center"><c:url var="nupdate"
						...
						</c:url> <c:url var="ndelete" value="ndelete.do">
							<c:param name="boardNo" value="${notice.boardNo }" />
						</c:url> <a href="${nupdate}">수정페이지로 이동</a>&nbsp; &nbsp; <a
						href="${ndelete }">삭제하기</a></td>
				</tr>
			</c:if>
		</table>
