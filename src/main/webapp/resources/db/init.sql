...
ALTER TABLE MEMBER ADD CONSTRAINT UQ1_MEMBER UNIQUE(MEMBER_PHONE);
...
ALTER TABLE FREE_FILE ADD CONSTRAINT PK_FREE_FILE PRIMARY KEY (
	FILE_NUM
);
...
ALTER TABLE ORDER_REVIEW ADD CONSTRAINT FK_ORDER_DETAIL_TO_ORDER_REVIEW_1 FOREIGN KEY (
	PRODUCT_NUM
)
...
ALTER TABLE ORDER_REVIEW ADD CONSTRAINT FK_ORDER_DETAIL_TO_ORDER_REVIEW_2 FOREIGN KEY (
	ORDER_NUM
)
REFERENCES ORDER_DETAIL (
	ORDER_NUM
